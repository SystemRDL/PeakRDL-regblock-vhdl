...
class Readback:
    ...
    def get_empty_implementation(self) -> str:
        ...
        template = self.exp.jj_env.get_template(
            "readback/templates/empty_readback_tmpl.vhd"
        )
    ...
    def get_1stage_implementation(self) -> str:
        ...
        template = self.exp.jj_env.get_template(
            "readback/templates/readback_no_rt_tmpl.vhd"
        )
    ...
    def low_addr_width(self) -> int:
        ...
        return (relevant_addr_width // 2) + unused_low_addr_bits


    @property
    def high_addr_width(self) -> int:
        return self.ds.addr_width - self.low_addr_width
    ...
    def get_2stage_implementation(self) -> str:
        ...
        context = {
            ...
            "cpuif": self.exp.cpuif,
            "ds": self.ds,
            "low_addr_width": self.low_addr_width,
            "high_addr_width": self.high_addr_width,
            'get_always_ff_event': self.exp.dereferencer.get_always_ff_event,
            'get_resetsignal': self.exp.dereferencer.get_resetsignal,
        }
        template = self.exp.jj_env.get_template(
            "readback/templates/readback_with_rt_tmpl.vhd"
        )
